...
#ifndef EMGgeneratorFrom6To24_h
#define EMGgeneratorFrom6To24_h
...
private:
  static const unsigned int noFromMuscles_ = 6;
  static const unsigned int noToMuscles_ = 24;
